...
object Constants {
    ...
    const val LOW_ACTIVITY = 80
    const val LIGHT_ACTIVITY = 90
    const val AVERAGE_ACTIVITY = 100
    const val HIGH_ACTIVITY = 110
    const val VERY_HIGH_ACTIVITY = 120

    //коэфициенты целей в %
    const val WEIGHT_LOSE = 90
